...
-- Funciones: Auto Farm Rocks, Auto Kill, Fast Punch, Fast Weight, TP & Gift.
...
p.Size, p.Position, p.Anchored, p.Transparency = Vector3.new(10000, 1, 10000), Vector3.new(0, -15, 0), true, 1

Rayfield:Notify({ Title = "DTH HUB CARGADO", Content = "Todo listo: Fast Punch, Weight, Rocks y Kill.", Duration = 5 })
